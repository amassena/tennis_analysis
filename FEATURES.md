...
| Filmstrip contact precision | `feature/visual/filmstrip-contact-precision` | `~/tennis_worktrees/filmstrip/` | scripts/swing_composite.py | active — earlier merge (11-panel window) shipped but contact panel still misses strike on many shots. Building ball-trajectory-inflection detector to get frame-precise contact at 240fps. |
